...
<div class="form-control !py-1 !my-0 hover:bg-base-200 rounded-md">
  <label class="label !py-0 cursor-pointer"
         title={$xpathsWritable.XPATH_ENABLE ? undefined : "This feature is currently being maintained."}>
...
<div class="form-control !py-1 !my-0 hover:bg-base-200 rounded-md">
  <label class="label !py-0 !my-0 cursor-pointer"
         title={$xpathsWritable.API_ENABLE ? undefined : "This feature is currently being maintained."}>
    <span class="label-text">API</span>
    <input
      type="radio"
      name="radio-10"
      class="radio radio-xs checked:bg-info"
      disabled={!$xpathsWritable.API_ENABLE}
